...
public class Madness {
	...
	public static int handb[] = {
			7, 10, 7, 15, 12, 8, 9, 10, 5, 7, 8, 10, 8, 12
	};
	/**
	 * Aerial rotation
	...
	public static float airs[] = {
			1.0F, 1.2F, 0.95F, 1.0F, 2.2F, 1.0F, 0.9F, 0.8F, 1.0F, 0.9F, 1.15F, 0.8F, 1.0F, 0.3F
	};
	/**
	 * Aerial control
	...
	public static int airc[] = {
			70, 30, 40, 40, 30, 50, 40, 90, 40, 50, 75, 10, 50, 0
	};
	/**
	...
	public static float grip[] = {
			20F, 27F, 18F, 22F, 19F, 20F, 25F, 20F, 16F, 24F, 22.5F, 25F, 30F, 27F
	};
	/**
	...
	public static float bounce[] = {
			1.2F, 1.05F, 1.3F, 1.15F, 1.3F, 1.2F, 1.15F, 1.1F, 1.2F, 1.1F, 1.15F, 0.8F, 1.05F, 0.8F
	};
	/**
	...
	public static float simag[] = {
			0.9F, 0.85F, 1.05F, 0.9F, 0.85F, 0.9F, 1.05F, 0.9F, 1.0F, 1.05F, 0.9F, 1.1F, 0.9F, 1.3F
	};
	/**
	 * Car strength
	 * @author Omar Waly
	...
	public static float moment[] = {
			1.2F, 0.75F, 1.4F, 1.0F, 0.85F, 1.25F, 1.4F, 1.3F, 1.2F, 1.45F, 1.375F, 2.0F, 1.2F, 3F
	};
	/**
	...
	public static float comprad[] = {
			0.5F, 0.4F, 0.8F, 0.5F, 0.3F, 0.5F, 0.5F, 0.5F, 0.5F, 0.8F, 0.5F, 1.0F, 0.5F, 0.6F
	};
	/**
	...
	public static int lift[] = {
			0, 30, 0, 20, 0, 30, 0, 0, 20, 0, 0, 0, 10, 0
	};
	/**
	...
	public static int powerloss[] = {
			...
			0x29f630, 0x44aa20, 0x3567e0, 0xfed260
	};
	/**
	...
	public static int flipy[] = {
			-50, -60, -92, -44, -60, -57, -54, -60, -77, -57, -82, -85, -28, -100
	};
	/**
	...
	public static int clrad[] = {
			3300, 1700, 4700, 3000, 2000, 4500, 3500, 1500, 10000, 15000, 4000, 7000, 10000, 30000
	};
	/**
	 * Damage Multiplier 
	...
	public static float dammult[] = {
			0.8F, 1.17F, 0.55F, 1.0F, 0.6F, 0.7F, 0.72F, 0.8F, 0.6F, 0.46F, 0.67F, 0.5F, 0.61F, 0.176F
	};
	/**
	...
	public static int maxmag[] = {
			6000, 4200, 7200, 6000, 6000, 9100, 14000, 12000, 12000, 9700, 13000, 10700, 13000, 30000
	};
    ...
    public void reseto(int i, ContO conto, CheckPoints checkpoints) {
        ...
        //if (checkpoints.stage >= 25 && im != 0) {
            //float d = 1.5F;
            //swits[cn][0] = ((int)((float) swits[cn][0] * d));
           // swits[cn][1] = ((int)((float) swits[cn][1] * d));
           // swits[cn][2] = ((int)((float) swits[cn][2] * d));
        // }
        
            
        
       
        //if (checkpoints.stage == 10 && im != 0 && im != 6) {       
             //conto.disp = 900;                    
